...
\begin{abstract}
Fiber to the home (FTTH) is widely implemented to provide higher bandwidth and lower end-to-end packet delay for subscribers. Among many optical access network technologies, passive optical network (PON) is a priority in FTTH deployment for its energy efficiency feature as well as deployment scalability. Due to the high energy consumption of the Optical Network Unit (ONU), a component of PON system, cyclic sleep mode is applied to save energy. Conventional cyclic sleep schemes strive to find a balance between energy efficiency and Quality of Service (QoS). With the rise of FTTH, a ONU only serves a few subscribers and it experiences longer idle time than before, which leaves much room for energy efficiency. In this paper, we classify the users' states into two types, i.e., active state and idle state. We prolong the sleep period when users are idle to reduce energy consumption. If the users are in active state, we cut down the sleep period to ensure the QoS. Since the sleep period need to be determined before an ONU goes into sleep state, we predict the users' states by their historical activities, which are from the actual data set. Simulation results show that our proposed scheme can achieve a considerable energy efficiency and QoS improvement.
\end{abstract}
...
\begin{figure}[t]
    \centering 
        \includegraphics[width=0.9\columnwidth]{PON.pdf}\\ 
...
\begin{figure}[t]
    \centering 
        \includegraphics[width=0.8\columnwidth]{status.pdf}\\ 
...
\begin{figure*}[h]
    ...
    \subfigure[] { \label{fig:a} 
        \includegraphics[width=0.474\columnwidth]{128_delay_energy_1.pdf}
    } 
    \subfigure[] { \label{fig:b} 
        \includegraphics[width=0.474\columnwidth]{128_delay_energy_2.pdf} 
    } 
    \subfigure[] { \label{fig:c} 
        \includegraphics[width=0.474\columnwidth]{128_delay_energy_3.pdf} 
    }
    \subfigure[] { \label{fig:d} 
        \includegraphics[width=0.474\columnwidth]{128_delay_energy_4.pdf} 
    } 
...
\begin{figure*}[h]
    \centering 
    \subfigure[] { \label{fig:a} 
        \includegraphics[width=0.474\columnwidth]{128_loss_energy_1.pdf}
    } 
    \subfigure[] { \label{fig:b} 
        \includegraphics[width=0.474\columnwidth]{128_loss_energy_2.pdf} 
    } 
    \subfigure[] { \label{fig:c} 
        \includegraphics[width=0.474\columnwidth]{128_loss_energy_3.pdf} 
    }
    \subfigure[] { \label{fig:d} 
        \includegraphics[width=0.474\columnwidth]{128_loss_energy_4.pdf} 
    } 
    \caption{Comparison between energy consumption (a), device lifetime (b), and migrated traffic amount (c) with a different number of postponed working wavelengths and postponed periods under traffic-III.} 
    \label{loss_energy} 
\end{figure*}
...
\begin{figure*}[h]
    \centering 
    \subfigure[] { \label{fig:a} 
        \includegraphics[width=0.474\columnwidth]{128_segment_delay_1.pdf}
    } 
    \subfigure[] { \label{fig:b} 
        \includegraphics[width=0.474\columnwidth]{128_segment_delay_2.pdf} 
    } 
    \subfigure[] { \label{fig:c} 
        \includegraphics[width=0.474\columnwidth]{128_segment_loss_1.pdf} 
    }
    \subfigure[] { \label{fig:d} 
        \includegraphics[width=0.474\columnwidth]{128_segment_loss_2.pdf} 
    } 
    \caption{Comparison between energy consumption (a), device lifetime (b), and migrated traffic amount (c) with a different number of postponed working wavelengths and postponed periods under traffic-III.} 
    \label{loss_energy} 
\end{figure*}
